                ...
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-4b3dcb8a="" class="d" style="width:750px;margin-left: 30px;margin-right: auto;" id="boxes">
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid {{($color == '#ffffff') ? 'black': $color}};">
                                ...
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        ...
                                        <p data-v-4b3dcb8a="">@if($settings['company_zipcode']) {{$settings['company_zipcode']}}@endif</p>
                                ...
                                <hr data-v-4b3dcb8a="" style="border-top: 1px solid {{($color == '#ffffff') ? 'black': $color}};">
                                <div data-v-4b3dcb8a="" class="break-25"></div>
                                <div data-v-4b3dcb8a="" class="row">
