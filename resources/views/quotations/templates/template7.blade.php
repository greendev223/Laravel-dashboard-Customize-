            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-1ad6e3b9="" class="d" style="width:750px;margin-left: 30px;margin-right: auto;" id="boxes">
                            <div data-v-1ad6e3b9="" class="d-inner d-no-pad" style="border-top: 15px solid {{($color == '#ffffff') ? 'black': $color}}; border-bottom: 15px solid {{($color == '#ffffff') ? 'black': $color}};">
                                <div data-v-1ad6e3b9="" class="row grey-box">
                                    <div data-v-1ad6e3b9="" class="col-33"><img data-v-1ad6e3b9="" src="{{$img}}" class="d-logo" style="max-width: 200px;"> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        ...
                                        <p data-v-1ad6e3b9="">@if($settings['company_zipcode']) {{$settings['company_zipcode']}}@endif</p>
                                        <p data-v-e95a8a8c="">@if(!empty($settings['tax_type']) && !empty($settings['vat_number'])){{$settings['tax_type'].' '. __('Number')}} : {{$settings['vat_number']}} @endif</p>
                                    </div>
                                    ...
                                    <div data-v-1ad6e3b9="" class="col-33"><h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{__('INVOICE')}}</h1> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        <table data-v-1ad6e3b9="" class="summary-table">
                                            ...
                                            <tr data-v-37eeda86="">
                                                ...
                                                <td data-v-37eeda86="" class="text-right">{{$user->quotationInvoiceNumberFormat($quotation->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu">{{__('Billing Date')}}:</td>
                                                <td data-v-37eeda86="" class="text-right">{{$user->dateFormat($quotation->created_at)}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu">{{__('Billing Time')}}:</td>
                                                <td data-v-37eeda86="" class="text-right">{{$user->timeFormat($quotation->created_at)}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu">{{__('Status')}}:</td>
                                                <td data-v-37eeda86="" class="text-right">{{ ($quotation->status == 1) ? __('Close') : __('Open') }}</td>
                                            </tr>
                                            <tr class="ml-8" style="position: absolute; right: 0;">
                                                <td class="">
                                                    <p>{!! DNS2D::getBarcodeHTML($user->quotationInvoiceNumberFormat($quotation->invoice_id),  'QRCODE',5,5) !!}</p>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div data-v-1ad6e3b9="" class="d-inner-2">
                                    <div data-v-1ad6e3b9="" class="row">
                                        <div data-v-1ad6e3b9="" class="col-2">
                                            <div data-v-1ad6e3b9="" class="col-66">
                                                <strong data-v-1ad6e3b9="">{{__('Bill To')}}:</strong>
                                    ...
                                    <div data-v-1ad6e3b9="" class="d-table">
                                        ...
                                        <div data-v-e95a8a8c="" class="tu d-table-tr" style="color: {{($color == '#ffffff') ? 'black': $color}}; border-bottom: 1px solid {{($color == '#ffffff') ? 'black': $color}}; border-top: 1px solid {{($color == '#ffffff') ? 'black': $color}};color:{{$font_color}};">
                                        ...
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{($color == '#ffffff') ? 'black': $color}}; border-bottom: 1px solid {{($color == '#ffffff') ? 'black': $color}};">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{ $quotation->subtotal }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
