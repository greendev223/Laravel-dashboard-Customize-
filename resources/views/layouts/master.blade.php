...
<body class="{{ $color }}">
	...
	<div id="header">
		<div class style="position:absolute; padding:120px;" >
			...
			<h2 class="text-white mb-sm-4 mt-4 wow animate__fadeInLeft" data-wow-delay="0.4s">
				{{ __('We can get a lot of products here') }}<br />
			</h2>
			<p class="text-white mb-sm-4 mt-4 wow animate__fadeInLeft" data-wow-delay="0.6s">
				Use these awesome forms to login or create new account in your project for free.
			</p>
		</div>
		<img class="d-block w-100" src="{{ asset('assets/images/slider/slider2.jpg') }}" alt="Second slide">
	</div>		
    <!-- [ Header ] End -->
    <!-- [ client ] Start -->
	...
	<div class="flex mt-sm-2" style="justify-content:center; text-align:center">
		<img style="width:24%;" src="{{asset('assets/images/featuredbanner/feature_clock.jpg')}}">
		<img style="width:24%;" src="{{asset('assets/images/featuredbanner/feature_bag.jpg')}}">
		<img style="width:24%;" src="{{asset('assets/images/featuredbanner/feature_lens.jpg')}}">
		<img style="width:24%;" src="{{asset('assets/images/featuredbanner/feature_trou.jpg')}}">
	</div>
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="{{ asset('landing/posgo-saas-pic-1.png') }}" alt="Datta Able Admin Template"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-9">
                    <div class="row feature-img-row">
                        <div class="col-3">
                            <img src="{{ asset('landing/posgo-saas-pic-1.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s"
                                alt="Admin" />
                        </div>
                        <div class="col-3">
                            <img src="{{ asset('landing/posgo-saas-pic-2.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.4s"
                                alt="Admin" />
                        </div>
                        <div class="col-3">
                            <img src="{{ asset('landing/posgo-saas-pic-3.png') }}"
