...
<body class="{{ $color }}">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    ...
                    <h2 class="text-white mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.4s">
                        {{ __('Projects, Accounting, Leads, Deals & HRM Tool') }}<br />
                    </h2>
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="#" class="btn btn-light me-2"><i class="far fa-eye me-2"></i>Live
                            Demo</a>
                        <a href="#" class="btn btn-outline-light" target="_blank"><i
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container ">
            ...
            <img src="{{ asset('landing/posgo-saas-pic-1.png') }}" alt=""
