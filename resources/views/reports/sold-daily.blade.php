        ...
        <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                    href="{{ route('sold.monthly.analysis') }}"
                    onclick="window.location.href = '{{ route('sold.monthly.analysis') }}'" role="tab"
                    ...
                    <div class="row input-daterange analysis-datepicker align-items-center">
                        <div class="form-group col-md-3 mb-0">
                            ...
                            <div class="input-group">
                                {{ Form::text('start-date', $start_date, ['class' => 'form-control', 'placeholder' => __('Select Start date')]) }}
                            </div>
                        </div>
                        <div class="form-group col-md-3 mb-0">
                            ...
                            <div class="input-group">
                                ...
                                {{ Form::text('end-date', $end_date, ['class' => 'form-control', 'placeholder' => __('Select End date')]) }}
                            </div>
                        </div>
    ...
    @push('scripts')
        ...
        <script type="text/javascript">
            ...
            function ajax_sale_daily_chart_filter() {
                ...
                $.ajax({
                    url: '{{ route('sold.daily.chart.filter') }}',
                    dataType: 'json',
                    data: data,
