...
@section('action-btn')    
    @can('Create Expense Category')
        <a  class="btn btn-sm btn-primary btn-icon " data-bs-toggle="tooltip" data-ajax-popup="true" data-title="{{__('Add New Category')}}"
                data-url="{{route('expensecategories.create')}}" title="{{ __('Add Category') }}"><span class="btn-inner--icon"><i class="ti ti-plus text-white"></i></span></a>
    @endcan
@endsection
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <div class="action-btn btn-info ms-2">
                                                <a href="#" data-ajax-popup="true" data-bs-toggle="tooltip" data-title="{{__('Edit Category')}}" title="{{__('Edit')}}"
