                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-group ms-3">
                                                        <a href="#" class="btn btn-print-invoice btn-lg  btn-primary m-b-10 m-r-10 apply-coupon" data-bs-toggle="tooltip"
                                                            title="{{ __('Apply') }}"><i
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-group ms-3 mt-4">
                                                        <a href="#" class="btn btn-print-invoice  mt-4 btn-primary  m-r-10 apply-coupon" data-bs-toggle="tooltip"
                                                            title="{{ __('Apply') }}"><i
                                                                class="" data-feather= "save"></i></a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-group w-100">
                                                        <label for="paypal_coupon"
                                                            class="col-form-label text-dark">{{ __('Coupon') }}</label>
                                                        <input type="text" id="mercado_coupon" name="coupon"col-form-label text-dark
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        @if (!empty($admin_payment_setting['is_paystack_enabled']) && isset($admin_payment_setting['is_paystack_enabled']) && $admin_payment_setting['is_paystack_enabled'] == 'on')
            ...
            window.location.href = paystack_callback + '/' + response.reference + '/' + '{{ encrypt($plan->id) }}' +
            '?coupon_id=' + coupon_id
            },
            onClose: function () {
            alert('window closed');
