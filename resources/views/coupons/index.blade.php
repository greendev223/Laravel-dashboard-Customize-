...
@section('page-title', __('Coupon List') )

@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0">{{ __('Coupon List') }}</h5>
    </div>
@endsection
...
@section('action-btn')
    @can('Create Coupon')
        <a class="btn btn-sm btn-primary btn-icon m-1"  data-bs-toggle="tooltip"
            data-size="lg" data-ajax-popup="true" data-title="{{__('Add New Coupon')}}" data-url="{{route('coupons.create')}}" title="{{ __('Add Coupon') }}"> <i class="ti ti-plus text-white"></i></a>
        </a>
    @endcan
@endsection
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <div class="action-btn btn-info ms-2">
                                                <a href="#" data-ajax-popup="true" data-bs-toggle="tooltip" title='edit' data-title="{{__('Edit Coupon')}}" title="{{__('Edit')}}" data-size="lg" data-url="{{route('coupons.edit', $coupon->id)}}"
