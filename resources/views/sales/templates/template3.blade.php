            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-e95a8a8c="" class="d" style="width:750px;margin-left: 30px;margin-right: auto;" id="boxes">
                            <div data-v-e95a8a8c="" class="d-inner">
                                ...
                                <div data-v-e95a8a8c="" class="row">
                                    <div data-v-e95a8a8c="" class="col-66"><strong data-v-e95a8a8c="" class="tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('From')}}:</strong>
                                        ...
                                        <p data-v-e95a8a8c="">@if($settings['company_zipcode']) {{$settings['company_zipcode']}}@endif</p>
                                        <p data-v-e95a8a8c=""> <br> @if(!empty($settings['tax_type']) && !empty($settings['vat_number'])){{$settings['tax_type'].' '. __('Number')}} : {{$settings['vat_number']}} <br>@endif </p>
                                    </div>
                                    <div data-v-e95a8a8c="" class="col-33">
                                        <table data-v-e95a8a8c="" class="summary-table">
                                            <tbody data-v-e95a8a8c="" style="position: relative">
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Number')}}:</td>
                                                <td data-v-37eeda86="" class="text-right">{{$user->sellInvoiceNumberFormat($sale->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Billing Date')}}:</td>
                                                <td data-v-37eeda86="" class="text-right">{{$user->dateFormat($sale->created_at)}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Billing Time')}}:</td>
                                                <td data-v-37eeda86="" class="text-right">{{$user->timeFormat($sale->created_at)}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Status')}}:</td>
                                            ...
                                            <tr class="ml-8" style="position: absolute; right: 0;">
                                                <td class="">
                                                    <p>{!! DNS2D::getBarcodeHTML($user->sellInvoiceNumberFormat($sale->invoice_id), "QRCODE",5,5) !!}</p>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
