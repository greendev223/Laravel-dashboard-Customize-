                        ...
                        <div class="row justify-content-center">
                            <div class="card card-body carttable cart-product-list" id="carthtml" style="margin-top: 5px;margin-bottom: 3px;">
                                ...
                                @php
                                        ...
                                        <div class="row mt-3" data-product-id="{{$id}}" id="product-id-{{$id}}">
                                            <div class="col-sm-2">
                            ...
                            <div class="card carts card-body col" style="margin-top: 3px;">
                                ...
                                <div class="tab-content mt-2" id="btn-pur">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <button type="button" class="btn btn-primary" data-ajax-popup="true" data-size="lg" data-align="centered" data-url="{{route('sales.create')}}" data-title="{{__('Sale Products')}}" @if(session($lastsegment) && !empty(session($lastsegment)) && count(session($lastsegment)) > 0) @else disabled="disabled" @endif>{{ __('PAY') }}</button>
                                        </div>
                                        <div class="col-sm-6">
