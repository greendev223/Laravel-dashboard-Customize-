...
<div class="row">
    ...
    <div class="form-group col-md-6">
        {{ Form::label('Product Categories', __('Product Categories'), ['class' => 'col-form-label']) }}
        {{ Form::email('Product Categories', null, ['class' => 'form-control', 'required'=>'required']) }}
    </div>
    <div class="form-group col-md-6">
        {{ Form::label('SKU', __('SKU'), ['class' => 'col-form-label']) }}
        {{ Form::text('SKU', null, ['class' => 'form-control', 'maxlength' => '15', 'placeholder' => __('Enter SKU')]) }}
    </div>
    <div class="form-group col-md-6">
        {{ Form::label('Product Tax', __('Product Tax'), ['class' => 'col-form-label']) }}
        {{ Form::text('Product Tax', null, ['class' => 'form-control']) }}
    </div>
    <div class="form-group col-md-6">
        {{ Form::label('Price', __('Price'), ['class' => 'col-form-label']) }}
        {{ Form::text('Price', null, ['class' => 'form-control', 'maxlength' => '15']) }}
    </div>

    <div class="form-group col-md-6">
        {{ Form::label('Last Price', __('Last Price'), ['class' => 'col-form-label']) }}
        {{ Form::text('Last Price', null, ['class' => 'form-control', 'maxlength' => '15']) }}
    </div>

    <div class="form-group col-md-6">
        {{ Form::label('Stock Quantity', __('Stock Quantity'), ['class' => 'col-form-label']) }}
        {{ Form::text('Stock Quantity', null, ['class' => 'form-control', 'maxlength' => '15', 'placeholder' => __('Enter Stock Quantity')]) }}
    </div>
    ...
    <div class="form-group col-md-6 py-4">
        <div class="form-check form-switch">
            ...
            <label class="form-check-label  " for="enable_product_variant">{{ __('Display Variants') }}</label>
        </div>
    </div>
    ...
    <!-- <div class="form-group">
        {{ Form::label('sub_images', __('Product Description'), ['class' => 'col-form-label']) }}
    </div>
    <div class="form-group">
