                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <h2 style="text-align:center; color: #000000; line-height:32px"><?php echo e(__('Welcome to '). $app_name .'!'); ?></h2>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style="margin: 10px 0; text-align: center;"><?php echo e(__('Hi ')); ?> <?php echo e($customer->name); ?>, <?php echo e(__(' Thank you for joining to '). $app_name .' as a '.$customer->type); ?></p>
                                                                <p style="margin: 10px 0; text-align: center;"><?php echo e(__('We will notify you when order is selled to you')); ?></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style="margin: 10px 0; text-align: center;"><i style="font-style:normal"><b style="font-weight:700"><?php echo e(__('Thank you for join to our team as a '.$customer->type)); ?></b></i></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
...
<?php /**PATH D:\My task\Germany\Laravel-dashboard-Customize-\resources\views/emails/customer_create.blade.php ENDPATH**/ ?>