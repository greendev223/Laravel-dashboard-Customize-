                                ...
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr class="ml-8" style="position: absolute; right: 0; top: 150px;">
                                                <td class="">
                                                    <p><?php echo DNS2D::getBarcodeHTML($user->quotationInvoiceNumberFormat($quotation->invoice_id),  'QRCODE',5,5); ?></p>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
...
<?php /**PATH E:\xampp\htdocs\wetransfer_scripts-to-install-onn-your-local-machine_2022-05-23_0954\posgo\main_file\resources\views/quotations/templates/template1.blade.php ENDPATH**/ ?>