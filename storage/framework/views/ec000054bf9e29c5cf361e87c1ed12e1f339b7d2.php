...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="my-4 text-xs text-muted text-center">
                        <p><?php echo e(__("Don't have an account?")); ?> <a href="<?php echo e(route('register',$lang)); ?>"><?php echo e(__('Create account')); ?></a></p>
                    </div>
                    <?php endif; ?> 
                </div>
            </form>
...
<?php endif; ?>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My task\Germany\Laravel-dashboard-Customize-\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>