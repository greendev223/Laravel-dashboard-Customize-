...
<?php $__env->startSection('action-btn'); ?>
        <div class="pr-2">
            <a href="#" data-size="md" data-url="<?php echo e(route('product_categorie.create')); ?>" data-ajax-popup="true"
                ...
                data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Create product categorie')); ?>"><i class="ti ti-plus"></i></a>
        </div>
<?php $__env->stopSection(); ?>
                                            ...
                                            <span>
                                                <div class="action-btn btn-primary ms-2">
                                                    <a href="#" data-size="md"
                                                        ...
                                                        data-ajax-popup="true" data-title="<?php echo e(__('Edit Categories')); ?>"
                                                        class="mx-3 btn btn-sm d-inline-flex align-items-center"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="<?php echo e(__('Edit Product')); ?>"><i
                                                ...
                                                <div class="action-btn bg-danger ms-2">
                                                    <a class="bs-pass-para align-items-center btn btn-sm d-inline-flex"
                                                        ...
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="<?php echo e(__('Delete Product Pategorie')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My task\Germany\Laravel-dashboard-Customize-\resources\views/product_category/index.blade.php ENDPATH**/ ?>