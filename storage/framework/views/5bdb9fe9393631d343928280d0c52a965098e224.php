...
<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0"><?php echo e(__('Products')); ?></h5>
    </div>
...
<?php $__env->startSection('action-btn'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Vendor')): ?>
        ...
        title="<?php echo e(__('Create Product')); ?>"
            data-url="<?php echo e(route('vendors.create')); ?>" class="btn btn-sm btn-primary btn-icon ">
            <span class=""><i class="ti ti-plus text-white"></i></span>
        </a>
    <?php endif; ?>

    <a href="<?php echo e(route('vendors.export')); ?>" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="tooltip" title="<?php echo e(__('Export')); ?>"> 
        <i class="ti ti-file-export text-white"></i> 
    </a>

    <a href="#" class="btn btn-sm btn-primary btn-icon " data-url="<?php echo e(route('vendors.file.import')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Import')); ?>"
        data-ajax-popup="true" data-title="<?php echo e(__('Import vendor CSV file')); ?>">
                                            ...
                                            <?php if($vendor->is_active == 1): ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Vendor')): ?>
                                                 <div class="action-btn btn-info ms-2">
                                                    <a href="#" data-ajax-popup="true" data-title="<?php echo e(__('Edit Vendor')); ?>"
                                                        data-url="<?php echo e(route('vendors.edit', $vendor->id)); ?>" data-size="lg"
                                                        class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Edit Vendor')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My task\Germany\Laravel-dashboard-Customize-\resources\views/vendors/index.blade.php ENDPATH**/ ?>