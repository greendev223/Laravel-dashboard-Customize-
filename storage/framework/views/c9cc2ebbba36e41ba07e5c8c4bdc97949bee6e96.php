    ...
    <nav class="navbar navbar-expand-md navbar-dark default">
      <div class="container">
        <a class="navbar-brand bg-transparent" href="#">
          ...
          <img  src="<?php echo e($logo . '/' . ('logo-light.png')); ?>" alt="logo" />
        </a>
        <button
    ...
    <section class="">
      <div class="container">
        <div class="row align-items-center justify-content-end mb-5">
          ...
          <div class="col-sm-6">
            <img
              src="<?php echo e(asset('landing/images/Dashboard1.png')); ?>"
              alt="Datta Able Admin Template"
              class="img-fluid header-img wow animate__fadeInRight"
              data-wow-delay="0.2s"
            />
        ...
        <div class="row align-items-center">
          ...
          <div class="col-sm-9">
            <div class="row feature-img-row">
              <div class="col-3">
                <img
                  src="<?php echo e(asset('assets/images/front/img-crm-dash-1.svg')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.2s"
                  alt="Admin"
                />
...
<?php /**PATH D:\My task\Germany\wetransfer_scripts-to-install-onn-your-local-machine_2022-05-23_0954\storego\main_file\resources\views/layouts/landing.blade.php ENDPATH**/ ?>