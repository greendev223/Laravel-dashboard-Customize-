...
<?php $__env->startSection('action-btn'); ?>
    ...
    <a href="<?php echo e(route('productsreturns.export')); ?>" data-bs-toggle="tooltip" class="btn btn-sm btn-primary btn-icon" title="<?php echo e(__('Export')); ?>">
        <i class="ti ti-file-export text-white"></i> 
    </a>

    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Returns')): ?>
        <a href="<?php echo e(route('productsreturn.create')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Add Return')); ?>" class="btn btn-sm btn-primary btn-icon m-1">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="pc-dt-simple" role="grid">
                            ...
                            <tr>
                                ...
                                <th style="text-right" width="117px"><?php echo e(__('Action')); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php $__currentLoopData = $returns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $return): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($return->vendor != null ? ucfirst($return->vendor->name) : __('Walk-in Vendor')); ?></td>
                                    <td><?php echo e($return->customer != null ? ucfirst($return->customer->name) : __('Walk-in Customer')); ?></td>
                                    ...
                                    <td class="pull-right text-right">
                                        ...
                                        <div class="action-btn btn-info ms-2">
                                            <a href="<?php echo e(route('productsreturn.edit', $return->id)); ?>" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" data-title="<?php echo e(__('Edit return')); ?>" title="<?php echo e(__('Edit')); ?>"><i class="ti ti-pencil text-white"></i></a>
                                        </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="action-btn bg-danger ms-2">
                                            <a href="#" class="bs-pass-para mx-3 btn btn-sm d-inline-flex align-items-center" data-toggle="sweet-alert"
                                                ...
                                                data-confirm-yes="delete-form-<?php echo e($return->id); ?>"  data-bs-toggle="tooltip"
                                                title="<?php echo e(__('Delete')); ?>"><i class="ti ti-trash text-white"></i>
                                            </a>
                                        </a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\wetransfer_scripts-to-install-onn-your-local-machine_2022-05-23_0954\posgo\main_file\resources\views/productsreturns/index.blade.php ENDPATH**/ ?>