        ...
        <div class="navbar-content">
            <ul class="dash-navbar">
                <?php if(Auth::user()->type == 'Owner'): ?>
                    <li
                        class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'dashboard' || Request::segment(1) == 'storeanalytic' ? ' active' : 'collapsed'); ?>">
                        <a href="#" class="dash-link"><span class="dash-micon">
                                <i class="ti ti-home"></i>
                            </span><span class="dash-mtext"><?php echo e(__('Dashboard')); ?></span><span
                    ...
                    <li
                        ...
                        <ul class="dash-submenu <?php echo e(Request::segment(1) == 'product.index' ? ' show' : ''); ?>">
                            ...
                            <li
                                class="dash-item <?php echo e(Request::route()->getName() == 'calendars.index' ? ' active' : ''); ?>">
                                <a class="dash-link"
                                    href="<?php echo e(route('calendars.index')); ?>"><?php echo e(__('Calendars')); ?></a>
                            </li>
                    ...
                    <li
                        class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'orders.index' ||  Request::route()->getName() == 'orders.show' ? ' active dash-trigger' : 'collapsed'); ?>">
                        <a href="<?php echo e(route('orders.index')); ?>"
                            class="dash-link <?php echo e(request()->is('orders.index') ? 'active' : ''); ?>"><span
                                class="dash-micon">
                                <i data-feather="credit-card"></i>
                            </span><span class="dash-mtext"><?php echo e(__('Orders')); ?></span></a>
                    </li>
                <?php endif; ?>
