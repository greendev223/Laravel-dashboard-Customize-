                ...
                <div class="col-xl-3">
                    <div class="card sticky-top " style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="#site-setting"
                                class="list-group-item list-group-item-action border-0"><?php echo e(__('Brand / Logo')); ?>
                            ...
                            <?php if(Auth::user()->isSuperAdmin()): ?>
                                <a href="#recaptcha-setting"
                                    class="list-group-item list-group-item-action border-0"><?php echo e(__('ReCaptcha Setting')); ?>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('System Settings')): ?>
                                <a href="#system-setting"
                                    class="list-group-item list-group-item-action border-0"><?php echo e(__('System')); ?>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Billing Settings')): ?>
                                <a href="#owner-setting"
                                    class="list-group-item list-group-item-action border-0"><?php echo e(__('Billing')); ?>
                    ...
                    <div id="site-setting" class="active">
                        ...
                        <div class="card ">
                            <div class="card-header">
                                <h5><?php echo e(__('Brands/logo')); ?></h5>
                            </div>
                            <div class="card-body ">
                                <div class="row">
                                                                ...
                                                                <div class="card-body pt-0">
                                                                    <div class=" setting-card">
                                                                        <div class="logo-content mt-4">
                                                                            <img src="<?php echo e(asset(Storage::url('logo/favicon.png'))); ?>"
                                                                                class="small-logo img_setting" alt="" />
                                                                        </div>
                                                                        <div class="choose-file  mt-5">
                                                                            <label for="favicon">
                                                                                <?php echo e(Form::file('favicon', ['class' => 'd-none', 'accept' => 'image/png', 'id' => 'small-favicon', 'data-filename' => 'edit-favicon'])); ?>

                                                                                <?php echo e(Form::label('small-favicon', __('Choose file'), ['class' => 'btn btn-primary'])); ?>
                                                                ...
                                                                <div class="card-body pt-0">
                                                                    <div class=" setting-card">
                                                                        <div class="logo-content mt-4">
                                                                            ...
                                                                            <img src="<?php echo e(asset(Storage::url('logo/logo-dark.png'))); ?>"
                                                                                width="170px" class="big-logo">

                                                                        </div>
                                                                        <div class="choose-file mt-5">
                                                                            <label for="logo_dark">
                                                                                <?php echo e(Form::file('logo_dark', ['class' => 'd-none', 'accept' => 'image/png', 'id' => 'logo-dark', 'data-filename' => 'edit-logo_dark'])); ?>

                                                                                <?php echo e(Form::label('logo-dark', __('Choose file'), ['class' => 'btn btn-primary'])); ?>
                                                                    ...
                                                                    <div class=" setting-card">
                                                                        ...
                                                                        <div class="choose-file mt-5">
                                                                            <label for="logo_light">
                                                                                <?php echo e(Form::file('logo_light', ['class' => 'd-none', 'accept' => 'image/png', 'id' => 'logo-light', 'data-filename' => 'edit-logo_light'])); ?>

                                                                                <?php echo e(Form::label('logo-light', __('Choose file'), ['class' => 'btn btn-primary'])); ?>
                                                                ...
                                                                <div class="card-body pt-0">
                                                                    <div class=" setting-card">
                                                                        <div class="logo-content mt-4">
                                                                            ...
                                                                            <img src="<?php echo e($logo . '/' . (isset($company_logo_dark) && !empty($company_logo_dark) ? $company_logo_dark : 'logo-dark.png')); ?>"
                                                                                width="170px" class="big-logo">
                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="form-group col-md-3">
                                            <div class="custom-control form-switch align-items-center gap-2 mt-2 p-0">
                                                <label class="form-check-label col-form-label text-dark"
                                                    for="disable_signup_button"><?php echo e(__('Sign Up')); ?></label><br>
                                        ...
                                        <div class="custom-control form-switch col-md-3 ">
                                            <label class="form-check-label col-form-label text-dark"
                                                for="display_landing"><?php echo e(__('Landing Page Display')); ?></label> <br>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-2">
                                            <div class="form-group d-block align-items-center mt-2">
                                                <?php echo e(Form::label('gdpr_cookie', __('GDPR Cookie'), ['class' => 'col-form-label text-dark'])); ?>
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-group gdpr_cookie_text mb-0">
                                                ...
                                                <textarea id="btn" type="text" name="cookie_text" class="form-control" rows="4" style="height: auto"
                                                    ...
                                                    placeholder="<?php echo e(__('Enter Gdpr Cookie Text ')); ?> <?php echo e(isset($settings['cookie_text']) && $settings['cookie_text'] ? $settings['cookie_text'] : ''); ?>"><?php echo e(isset($settings['cookie_text']) && $settings['cookie_text'] ? $settings['cookie_text'] : ''); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <?php if(Auth::user()->isSuperAdmin()): ?>
                            <div id="payment-setting" class="card faq">
                                ...
                                <div class="row justify-content-center">
                                    <div class="card-header">
                                        <small
                                            class="col-form-label text-dark "><?php echo e(__('This detail will use for make purchase of plan.')); ?></small>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                        <div class="form-group col-lg-6">
                                            <label for="currency_symbol"
                                                class="col-form-label text-dark"><?php echo e(__('Currency')); ?></label>
                                            <input type="text" name="currency_symbol" id="currency_symbol"
                                                class="form-control" placeholder="<?php echo e(__('Enter Currency Symbol')); ?>"
                                        ...
                                        <div class=" col-lg-6">
                                            <label for="currency"
                                                class="col-form-label text-dark"><?php echo e(__('Currency Code')); ?></label>
                                            <input type="text" name="currency" id="currency" class="form-control"
                                                value="<?php echo e(env('CURRENCY')); ?>"
                                            ...
                                            <small class="text-dark">
                                                <?php echo e(__('Note: Add currency code as per three-letter ISO code.')); ?> <a
                                                    href="https://stripe.com/docs/currencies"
                                                    target="_new"><?php echo e(__('you can find out here.')); ?></a>.</small>
                                        </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="mercado_app_id"
                                                                            ...
                                                                            value="<?php echo e(isset($admin_payment_setting['mercado_app_id']) ? $admin_payment_setting['mercado_app_id'] : ''); ?>"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="mercado_secret_key"
                                                                            class="form-label text-dark"><?php echo e(__('App Secret KEY')); ?></label>
                                                                        <input type="text" name="mercado_secret_key"
                                                                            id="mercado_secret_key" class="form-control"
                                                                            value="<?php echo e(isset($admin_payment_setting['mercado_secret_key']) ? $admin_payment_setting['mercado_secret_key'] : ''); ?>"
                                                                            placeholder="<?php echo e(__('App Secret Key')); ?>" />
                                                                            ...
                                                                            <div class="form-check">
                                                                                <label
                                                                                    ...
                                                                                    <input type="radio" name="paytm_mode"
                                                                                        value="local"
                                                                                        <?php echo e((isset($admin_payment_setting['paytm_mode']) && $admin_payment_setting['paytm_mode'] == '') || (isset($admin_payment_setting['paytm_mode']) && $admin_payment_setting['paytm_mode'] == 'local') ? 'checked="checked"' : ''); ?>><?php echo e(__('Local')); ?>
                                                                        ...
                                                                        <div class="border card p-3">
                                                                            <div class="form-check">
                                                                                <label
                                                                                    ...
                                                                                    <input type="radio" name="paytm_mode"
                                                                                        value="production"
                                                                                        <?php echo e(isset($admin_payment_setting['paytm_mode']) && $admin_payment_setting['paytm_mode'] == 'production' ? 'checked="checked"' : ''); ?>><?php echo e(__('Production')); ?>
                                                                                ...
                                                                                <div class="form-check">
                                                                                    <label
                                                                                        ...
                                                                                        <input type="radio"
                                                                                            name="coingate_mode"
                                                                                            value="sandbox"
                                                                                            <?php echo e((isset($admin_payment_setting['coingate_mode']) && $admin_payment_setting['coingate_mode'] == '') || (isset($admin_payment_setting['coingate_mode']) && $admin_payment_setting['coingate_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>><?php echo e(__('Sandbox')); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                ...
                                                <div class="">
                                                    ...
                                                    <label class="text-dark mb-1 mt-3"
                                                        for="recaptcha_module"><?php echo e(__('Google Recaptcha')); ?><a
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                <label for="google_recaptcha_key"
                                                    class="col-form-label col-form-label text-dark"><?php echo e(__('Google Recaptcha Key')); ?></label>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                <label for="google_recaptcha_secret"
                                                    class="col-form-label col-form-label text-dark"><?php echo e(__('Google Recaptcha Secret')); ?></label>
                                                <input class="form-control "
                                ...
                                <div class="email-setting-wrap">
                                    ...
                                    <div class="row card-body">
                                        <div class="form-group col-md-4">
                                            ...
                                            <?php echo e(Form::text('company_name', null, ['class' => 'form-control font-style', 'required' => 'required'])); ?>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <?php echo e(Form::text('company_email', null, ['class' => 'form-control', 'required' => 'required'])); ?>

                                        </div>
                                        <div class="form-group col-md-4">
                                            <?php echo e(Form::label('company_email_from_name', __('Email (From Name) *'), ['class' => 'form-label text-dark'])); ?>

                                            <?php echo e(Form::text('company_email_from_name', null, ['class' => 'form-control font-style', 'required' => 'required'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\wetransfer_scripts-to-install-onn-your-local-machine_2022-05-23_0954\posgo\main_file\resources\views/settings/index.blade.php ENDPATH**/ ?>