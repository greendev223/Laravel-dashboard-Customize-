<?php $__env->startSection('page-title', __('Coupon List') ); ?>

<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0"><?php echo e(__('Coupon List')); ?></h5>
    </div>
...
<?php $__env->startSection('action-btn'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Coupon')): ?>
        <a class="btn btn-sm btn-primary btn-icon m-1"  data-bs-toggle="tooltip"
            data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Add New Coupon')); ?>" data-url="<?php echo e(route('coupons.create')); ?>" title="<?php echo e(__('Add Coupon')); ?>"> <i class="ti ti-plus text-white"></i></a>
        </a>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <div class="action-btn btn-info ms-2">
                                                <a href="#" data-ajax-popup="true" data-bs-toggle="tooltip" title='edit' data-title="<?php echo e(__('Edit Coupon')); ?>" title="<?php echo e(__('Edit')); ?>" data-size="lg" data-url="<?php echo e(route('coupons.edit', $coupon->id)); ?>"
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete Coupon')): ?>
                                             <div class="action-btn bg-danger ms-2">
                                                <a href="#" class="bs-pass-para mx-3 btn btn-sm d-inline-flex align-items-center show_confirm" data-bs-toggle="tooltip" title="Delete"  data-toggle="sweet-alert"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\wetransfer_scripts-to-install-onn-your-local-machine_2022-05-23_0954\posgo\main_file\resources\views/coupons/index.blade.php ENDPATH**/ ?>