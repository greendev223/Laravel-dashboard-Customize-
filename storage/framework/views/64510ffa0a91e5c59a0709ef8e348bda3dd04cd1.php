...
<?php $__env->startSection('action-btn'); ?>
    <div class="pr-2">
        <a href="#" data-size="md" data-url="<?php echo e(route('product_tax.create')); ?>" data-ajax-popup="true"
            ...
            data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Create New Product Tax')); ?>"><i class="ti ti-plus"></i></a>
    </div>
<?php $__env->stopSection(); ?>
                                        ...
                                        <span>
                                            <div class="action-btn btn-primary ms-2">
                                                <a href="#" data-size="md"
                                                    ...
                                                    title="<?php echo e(__('Edit Tax')); ?>"><i
                                            ...
                                            <div class="action-btn bg-danger ms-2">
                                                <a class="bs-pass-para align-items-center btn btn-sm d-inline-flex"
                                                    ...
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="<?php echo e(__('Delete Tax')); ?>">
                                                    <i class="ti ti-trash"></i>
                                                </a>
                                                <?php echo Form::open(['method' => 'DELETE', 'route' => ['product_categorie.destroy', $product_tax->id], 'id' => 'delete-form-' . $product_tax->id]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\My task\Germany\Laravel-dashboard-Customize-\resources\views/producttax/index.blade.php ENDPATH**/ ?>