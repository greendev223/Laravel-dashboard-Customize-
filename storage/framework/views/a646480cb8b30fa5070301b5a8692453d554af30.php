...
<?php $__env->startSection('action-btn'); ?>
    <div class="col-lg-12 col-md-12 col-12 mb-3 text-right">
        <div class="d-flex align-items-center">
            <button type="button" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="collapse"
            data-bs-toggle="tooltip" 
                data-bs-target=".multi-collapse" title="<?php echo e(__('Filter')); ?>"> <i class="ti ti-filter"></i> </button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\wetransfer_scripts-to-install-onn-your-local-machine_2022-05-23_0954\posgo\main_file\resources\views/reports/sale.blade.php ENDPATH**/ ?>